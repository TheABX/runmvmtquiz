...
const TRAINING_VOLUME_BANDS: VolumeBandsConfig = {
  "5k": {
    complete: {
      ...
      lower_intermediate: { startMin: 20, startMax: 30, peakMin: 30, peakMax: 42 },
      intermediate: { startMin: 25, startMax: 35, peakMin: 35, peakMax: 50 },
      upper_intermediate: { startMin: 30, startMax: 40, peakMin: 42, peakMax: 60 },
  ...
  "10k": {
    complete: {
      ...
      lower_intermediate: { startMin: 25, startMax: 35, peakMin: 35, peakMax: 47 },
      intermediate: { startMin: 30, startMax: 40, peakMin: 40, peakMax: 55 },
      upper_intermediate: { startMin: 35, startMax: 47, peakMin: 47, peakMax: 65 },
  ...
  "half_marathon": {
    complete: {
      ...
      lower_intermediate: { startMin: 30, startMax: 40, peakMin: 40, peakMax: 57 },
      intermediate: { startMin: 35, startMax: 45, peakMin: 45, peakMax: 65 },
      upper_intermediate: { startMin: 40, startMax: 52, peakMin: 55, peakMax: 75 },
  ...
  "marathon": {
    complete: {
      ...
      lower_intermediate: { startMin: 35, startMax: 50, peakMin: 52, peakMax: 70 },
      intermediate: { startMin: 40, startMax: 55, peakMin: 60, peakMax: 80 },
      upper_intermediate: { startMin: 47, startMax: 62, peakMin: 70, peakMax: 92 },
  ...
  "50k": {
    complete: {
      ...
      lower_intermediate: { startMin: 40, startMax: 52, peakMin: 62, peakMax: 80 },
      intermediate: { startMin: 45, startMax: 60, peakMin: 70, peakMax: 90 },
      upper_intermediate: { startMin: 52, startMax: 67, peakMin: 77, peakMax: 100 },
  ...
  "80k": {
    complete: {
      ...
      lower_intermediate: { startMin: 50, startMax: 65, peakMin: 77, peakMax: 100 },
      intermediate: { startMin: 55, startMax: 70, peakMin: 85, peakMax: 110 },
      upper_intermediate: { startMin: 62, startMax: 80, peakMin: 92, peakMax: 120 },
  ...
  "100k_plus": {
    complete: {
      ...
      lower_intermediate: { startMin: 55, startMax: 72, peakMin: 87, peakMax: 110 },
      intermediate: { startMin: 60, startMax: 80, peakMin: 95, peakMax: 120 },
      upper_intermediate: { startMin: 67, startMax: 87, peakMin: 102, peakMax: 130 },
